...
//        driver.close();
    ...
    public void testLoginIntoApplication() throws InterruptedException {
        ...
        String invalidCredentialsText = driver.findElements(By.tagName("p")).getFirst().getText();
        String expectedInvalidCredentialsText = "Invalid credentials";
        Assert.assertEquals(invalidCredentialsText, expectedInvalidCredentialsText);
    }
}
